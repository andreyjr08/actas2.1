<?php 
   ...
   $Result2 = $usuarios ->select_person($id);
	...
	$pdf->Cell(10,5,':',0);
	$pdf->Cell(30,5,utf8_decode(''.utf8_decode($Result2['COMPUTADOR'])),0);
	$pdf->Ln(5);
    $pdf->Cell(40,5,'ACTIVO FIJO',0);
	$pdf->Cell(10,5,':',0);
	$pdf->Cell(30,5,utf8_decode(''.utf8_decode($Result2['ACTIVO_FIJO'])),0);
	$pdf->Ln(5);
    $pdf->Cell(40,5,'SERIAL',0);
	$pdf->Cell(10,5,':',0);
	$pdf->Cell(30,5,utf8_decode(''.utf8_decode($Result2['SERIAL'])),0);
	$pdf->Ln(5);
    $pdf->Cell(40,5,'PROCESADOR',0);
	$pdf->Cell(10,5,':',0);
	$pdf->Cell(30,5,utf8_decode(''.utf8_decode($Result2['PROCESADOR'])),0);
	$pdf->Ln(5);
    $pdf->Cell(40,5,'MEMORIA RAM',0);
	$pdf->Cell(10,5,':',0);
	$pdf->Cell(30,5,utf8_decode(''.utf8_decode($Result2['MEMORIA_RAM'])),0);
	$pdf->Ln(5);
    $pdf->Cell(40,5,'SERIAL CARGADOR',0);
	$pdf->Cell(10,5,':',0);
	$pdf->Cell(30,5,utf8_decode(''.utf8_decode($Result2['SERIAL_CARGADOR'])),0);
	$pdf->Ln(10);
$pdf->SetFont('Arial','',11);
